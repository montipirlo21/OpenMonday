...
public class TestDataBuilders_MondayDriverBoardStructure
{
    ...
    public static OperationResult<IGetBoardsStructureByIdResult> GenerateSimpleBoardResult()
    {
        ...
        var listColumn = new List<GetBoardsStructureById_Boards_Columns_Column>(){
            ...
            new("project_owner", "Owner", "{\"hide_footer\":false,\"max_people_allowed\":\"0\"}"),
            new("project_status", "Status",  "{\"done_colors\":[1],\"labels\":{\"0\":\"Working on it\",\"1\":\"Done\",\"2\":\"Stuck\"},\"labels_positions_v2\":{\"0\":0,\"1\":2,\"2\":1,\"5\":3},\"labels_colors\":{\"0\":{\"color\":\"#fdab3d\",\"border\":\"#e99729\",\"var_name\":\"orange\"},\"1\":{\"color\":\"#00c875\",\"border\":\"#00b461\",\"var_name\":\"green-shadow\"},\"2\":{\"color\":\"#df2f4a\",\"border\":\"#ce3048\",\"var_name\":\"red-shadow\"}}}"),
            new("date", "Due date",string.Empty),
            new("timeline__1", "Timeline","{\"hide_footer\":false,\"show_set_as_milestone\":false}")
        };

        IGetBoardsStructureByIdResult data = new GetBoardsStructureByIdResult(new List<GetBoardsStructureById_Boards_Board>()
        {
            new(boardId, boardName, listColumn)
        });
